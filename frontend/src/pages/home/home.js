  ...
  render() {
    ...
    return (
      <View className="index">
        {this.state.isH5 ? <AtNavBar title="开课吧1111"></AtNavBar> : null}
        ...
        <View style="margin-top:10px">
          {this.state.goods.map(item => {
            ...
            return (
              <AtCard title={item.name} note="课程简介简介简介课程简介简介简介课程简介简介简介课程简介简介简介" extra={`￥${item.price}`} thumb={thumb}>
        ...
        {this.state.hasMore ? <View>{this.state.isH5 ? <AtLoadMore onClick={this.loadMore} /> : null}</View> : <AtDivider content="没有更多了" color="#e93b3d"></AtDivider>}
      </View>
    )
  }
}
